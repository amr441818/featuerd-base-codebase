  ...
  return (
    <div className='flex items-center justify-center gap-[13px]'>
      <a
        ...
        target='_blank'
        className={`flex h-[36px] w-[36px] items-center justify-center rounded-full border-[1px] border-[#fff]/[0.18] fill-current text-[#FFFFFF] transition-all duration-300 hover:bg-[#fff] hover:text-[#389C63]`}
      >
        <svg
          id='_2253'
          data-name='2253'
      ...
      <a
        ...
        className={`flex h-[36px] w-[36px] items-center justify-center rounded-full border-[1px] border-[#fff]/[0.18] fill-current text-[#FFFFFF] transition-all duration-300 hover:bg-[#fff] hover:text-[#389C63]`}
      >
        <svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' viewBox='0 0 13.905 13.405'>
          <path
            id='snapchat'
