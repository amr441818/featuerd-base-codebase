...
export function FormFieldRenderer({ field }: { field: FieldConfig }) {
  ...
  switch (field.type) {
    case 'input':
      return <FormInput name={field.name} label={field.label} placeholder={field.placeholder} icon={field.icon} />;
    ...
    case 'select':
      return (
        <FormSelect
          ...
          renderTrigger={field.renderTrigger}
        />
      );
    ...
    case 'radio-group':
      return (
        <FormRadioGroup
          ...
          className={field.className}
          renderOption={field.renderOption as any}
          renderTrigger={field.renderTrigger as any}
        />
      );
