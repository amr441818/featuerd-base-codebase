...
const InputComponent = (props: customInputProps) => {
  ...
  return (
    <div className={` ${props?.className ? props?.className : "lg:col-span-6 col-span-12"}`}>
      {props.label && (
        <label
          htmlFor="name"
