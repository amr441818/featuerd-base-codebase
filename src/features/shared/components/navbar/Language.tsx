...
const Language = ({ className,isMobile }: { className?: string ,isMobile?: boolean}) => {
  ...
  return (
    <>
      <div className={` flex justify-center items-center     cursor-pointer `} onClick={toggleLanguage}>
        <button
